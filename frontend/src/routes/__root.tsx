  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong on our end. Retry or return to the case list.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OpsPilot AI — Evidence Correlation Engine" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "OpsPilot AI" },
      { property: "og:title", content: "OpsPilot AI — Evidence Correlation Engine" },
      {
        property: "og:description",
        content: "Find what everyone else missed. Evidence-backed operational intelligence.",
      },
